...
## Verificar enquanto o servidor de desenvolvimento roda [#verifying-while-the-dev-server-runs]
...
## Validar links [#validating-links]
...
## Auditar o site compilado [#auditing-the-built-site]
...
### Verificar um deploy ativo [#checking-a-live-deployment]
...
### Corrigir as constatações com um agente [#fixing-the-findings-with-an-agent]
...
### O que ele verifica e o que não verifica [#what-it-does-and-doesnt-check]
